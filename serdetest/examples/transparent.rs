...
clippy :: absolute_paths,)] const _ : () =
{
    ...
    DeriveStruct
    {
        ...
        __private :: Result < __S :: Ok, __S :: Error > where __S : _serde ::
        Serializer,
        { _serde :: Serialize :: serialize(& self.base, __serializer) }
    }
};
...
clippy :: absolute_paths,)] const _ : () =
{
    ...
    Deserialize < 'de > for DeriveStruct
    {
        ...
        'de > ,
        {
            ...
            map(_serde :: Deserialize :: deserialize(__deserializer), |
            __transparent | DeriveStruct
            {
                base : __transparent, pattern : _serde :: __private :: Default
                :: default()
            })
        }
    }
