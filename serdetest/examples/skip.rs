        ...
        'de > ,
        {
            ...
            'de > for __FieldVisitor
            {
                ...
                :: de :: Error,
                {
                    match __value
                    {
                        "base" => _serde :: __private :: Ok(__Field :: __field0), _
                        => { _serde :: __private :: Ok(__Field :: __ignore) }
                    }
                } fn visit_bytes < __E > (self, __value : & [u8]) -> _serde ::
                __private :: Result < Self :: Value, __E > where __E : _serde
                :: de :: Error,
                {
                    match __value
                    {
                        b"base" => _serde :: __private :: Ok(__Field :: __field0), _
                        => { _serde :: __private :: Ok(__Field :: __ignore) }
                    }
                }
            } #[automatically_derived] impl < 'de > _serde :: Deserialize <
            ...
            'de > for __Visitor < 'de >
            {
                ...
                where __A : _serde :: de :: SeqAccess < 'de > ,
                {
                    ...
                    next_element :: < Vec < BaseStruct > > (& mut __seq) ?
                    {
                        ...
                        Err(_serde :: de :: Error ::
                        invalid_length(0usize, &
                        "struct DeriveStruct with 1 element")),
                    }; let __field1 = _serde :: __private :: Default ::
                    default(); _serde :: __private ::
                ...
                {
                    let mut __field0 : _serde :: __private :: Option < Vec <
                    BaseStruct > > = _serde :: __private :: None; while let
                    ...
                    Ok(DeriveStruct
                    {
                        base : __field0, pattern : _serde :: __private :: Default ::
                        default()
                    })
                }
            } #[doc(hidden)] const FIELDS : & 'static [& 'static str] = &
            ["base"]; _serde :: Deserializer ::
