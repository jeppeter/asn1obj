        ...
        'de > ,
        {
            ...
            'de > for __Visitor < 'de >
            {
                ...
                where __A : _serde :: de :: SeqAccess < 'de > ,
                {
                    ...
                    Ok(BaseStruct { name : __field0, cc : __field1 })
    ...
    clippy :: absolute_paths,)] const _ : () =
{
    ...
    DeriveStruct
    {
        ...
        Serializer,
        {
            ...
            _serde :: ser :: SerializeStruct ::
            serialize_field(& mut __serde_state, "ccb", & self.pattern) ? ;
    ...
    clippy :: absolute_paths,)] const _ : () =
{
    ...
    impl<'de> _serde ::Deserialize < 'de > for DeriveStruct
    {
        fn deserialize < __D > (__deserializer : __D) -> _serde :: __private
        :: Result < Self, __D :: Error > where __D : _serde :: Deserializer <
        'de > ,
        {
            ...
            :: Visitor < 'de > for __FieldVisitor
            {
                ...
                :: de :: Error,
                {
                    match __value
                    {
                        ...
                        "ccb" => _serde :: __private :: Ok(__Field :: __field1), _
                        => { _serde :: __private :: Ok(__Field :: __ignore) }
                    }
                } fn visit_bytes < __E > (self, __value : & [u8]) -> _serde ::
                __private :: Result < Self :: Value, __E > where __E : _serde
                :: de :: Error,
                {
                    match __value
                    {
                        ...
                        b"ccb" => _serde :: __private :: Ok(__Field :: __field1), _
                        => { _serde :: __private :: Ok(__Field :: __ignore) }
                    }
                }
            } #[automatically_derived] impl < 'de > _serde :: Deserialize <
            ...
            'de > for __Visitor < 'de >
            {
                ...
                where __A : _serde :: de :: MapAccess < 'de > ,
                {
                    let mut __field0 : _serde::__private::Option<Vec<BaseStruct>> = _serde::__private::None; 
                    let mut __field1 : _serde::__private::Option<NoPatternStruct> = _serde::__private::None;
