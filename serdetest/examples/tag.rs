        ...
        Serializer,
        {
            match * self
            {
                DeriveEnum :: Enum1 =>
                {
                    ...
                    :: ser :: SerializeStruct ::
                    serialize_field(& mut __struct, "type", "Enum1") ? ; _serde
                    :: ser :: SerializeStruct :: end(__struct)
                } DeriveEnum :: Enum3 =>
                {
                    let mut __struct = _serde :: Serializer ::
                    serialize_struct(__serializer, "DeriveEnum", 1) ? ; _serde
                    :: ser :: SerializeStruct ::
                    serialize_field(& mut __struct, "type", "Enum3") ? ; _serde
                    :: ser :: SerializeStruct :: end(__struct)
                } DeriveEnum :: EnumCC =>
                {
                    let mut __struct = _serde :: Serializer ::
                    serialize_struct(__serializer, "DeriveEnum", 1) ? ; _serde
                    :: ser :: SerializeStruct ::
                    serialize_field(& mut __struct, "type", "EnumCC") ? ; _serde
                    :: ser :: SerializeStruct :: end(__struct)
                }
            }
        }
...
clippy :: absolute_paths,)] const _ : () =
{
    ...
    Deserialize < 'de > for DeriveEnum
    {
        ...
        'de > ,
        {
            ...
            ["Enum1", "Enum3", "EnumCC"]; let (__tag, __content) = _serde ::
            Deserializer ::
            deserialize_any(__deserializer, _serde :: __private :: de ::
            TaggedContentVisitor :: < __Field > ::
            new("type", "internally tagged enum DeriveEnum")) ? ; let
            __deserializer = _serde :: __private :: de :: ContentDeserializer
            :: < __D :: Error > :: new(__content); match __tag
            {
                __Field :: __field0 =>
                {
                    _serde :: Deserializer ::
                    deserialize_any(__deserializer, _serde :: __private :: de ::
                    InternallyTaggedUnitVisitor :: new("DeriveEnum", "Enum1")) ?
                    ; _serde :: __private :: Ok(DeriveEnum :: Enum1)
                } __Field :: __field1 =>
                {
                    _serde :: Deserializer ::
                    deserialize_any(__deserializer, _serde :: __private :: de ::
                    InternallyTaggedUnitVisitor :: new("DeriveEnum", "Enum3")) ?
                    ; _serde :: __private :: Ok(DeriveEnum :: Enum3)
                } __Field :: __field2 =>
                {
                    _serde :: Deserializer ::
                    deserialize_any(__deserializer, _serde :: __private :: de ::
                    InternallyTaggedUnitVisitor :: new("DeriveEnum", "EnumCC"))
